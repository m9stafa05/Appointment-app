...
class Failed<T> implements LoginState<T> {
...
@override
String toString() {
  return 'LoginState<$T>.failed(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<T,$Res> implements $LoginStateCopyWith<T, $Res> {
